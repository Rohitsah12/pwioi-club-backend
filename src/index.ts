...
import cprDashboardRoutes from "./routes/cprDashboard.routes.js";
import attendanceDashboardRoutes from "./routes/attendanceDashboard.routes.js";
...
app.use('/api/cpr-dashboard',cprDashboardRoutes);
