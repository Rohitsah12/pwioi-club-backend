...
jobRoutes.put("/:jobId",authenticateJwt,requireRoles("ADMIN","SUPER_ADMIN","BATCHOPS","OPS"),updateJob)
jobRoutes.delete("/:jobId",authenticateJwt,requireRoles("ADMIN","SUPER_ADMIN","BATCHOPS","OPS"),deleteJob)
