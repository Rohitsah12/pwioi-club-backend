...
import { uploadCprSheet, getCprBySubject, deleteCprBySubject, getCprSummaryForSchool } from '../controllers/cpr.controller.js';
...
cprRoutes.get('/summary/school', authenticateJwt, requireRoles("ADMIN", "SUPER_ADMIN", "OPS", "BATCHOPS"), getCprSummaryForSchool);
